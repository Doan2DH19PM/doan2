                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('public/site') }}/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('public/site') }}/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('public/site') }}/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('public/site') }}/dist/img/user2-160x160.jpg"
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('phim') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Phim</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('dangphim') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dạng Phim</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('ghe') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ghế</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('loaiphim') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Loại Phim</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('ve') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Vé</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('loaive') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Loại vé</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('xuatchieu') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Xuất Chiếu</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('phongchieuphim') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Phòng chiếu phim</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('chitietchieuphim') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>chi Tiết Chiếu Phim</p>
                                    </a>
                                </li>
                                <li class="nav-item">
