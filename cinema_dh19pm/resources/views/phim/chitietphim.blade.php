    ...
    <div class="row">
        <div class="col-md-9 single_left">
                ...
                <ul id="etalage">
                    <li style="list-style: none">
                        <a href="optionallink.html">
                          <img class="etalage_thumb_image" src="{{ asset('/upload/images/' .$phim->hinhanh) }}" style="height: 400px;
                          width: 250px;" />
                        </a>
                    </li>
            ...
            <div class="single_right">
                ...
                <p class="m_10">Đạo Diển: {{ $phim->daodien }}</p>
                <p class="m_10">Diển Viên: {{ $phim->dienvien }}</p>
                <p class="m_10">Ngày Sản Xuất: {{ $phim->ngaysanxuat }}</p>
                <p class="m_10">Dạng Phim:  </p>
                <p class="m_10">Loại Phim {{ $phim->loaihpim }}</p>
                <ul class="options">
